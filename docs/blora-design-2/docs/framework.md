...
Blora.applyPalette('ocean'); // cinnabar | indigo | lotus | ocean | graphite | mono | circuit | dusk
...
视觉形态不随配色改变。丹砂、靛青、藕荷、海盐、Graphite、Mono、Circuit 与 Dusk 都只负责颜色映射，其中 Dusk 是默认配色。
